...
export class MaintenanceEdit extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            building_id: 1,
                ...
                <View key={ index } style={{ backgroundColor: backgroundColor }}>
                    <View style={{ flexDirection: 'row' }}>
                        <Text style={{
                            ...
                            paddingTop: 8,
                            paddingBottom: 8
                        }}>{ request[8][0] + ' ' + request[8][1][0] + '.' }</Text>
                        <Text style={{
                            flex: 3,
                            alignSelf: 'center',
                            textAlign: 'center',
        ...
        return fetch('https://comp490.000webhostapp.com/public/maintenance.php', {
            ...
            .then(responseJson => {
                if(!responseJson.success)
                    ...
                    console.log(responseJson);
                    this.props.navigation.push('MaintenanceEditScreen', { email: this.state.email });
                }
            })
            .catch(error => console.warn(error));
    }
        ...
        return (
            <View style={ styles.container }>
                ...
                <View style={ styles.footerStyle }>
                    <TouchableOpacity
                        onPress={ () => this.props.navigation.push('MaintenanceEditScreen', { email: this.state.email}) }
